 ...
 * 
 */
package com.apiServiceClient.config;
...
@Configuration
@EnableJpaRepositories(basePackages={"com.apiServiceClient.model"}, entityManagerFactoryRef="localContainerEntityManagerFactoryBean")
